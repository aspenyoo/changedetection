function Exp_OrientationChangeDetect(subjid, sessionnum,nTrialsPerCond)
...
% final screen
Screen('fillRect',windowPtr,prefs.bgColor);
Screen('DrawText',windowPtr,'End of the detection task. You did great! Press <ENTER> to continue',250,screenCenter(2) - 50,prefs.white);
Screen('Flip', windowPtr);
key = 0;
while (key ~= 13)
    key = waitForKey;
